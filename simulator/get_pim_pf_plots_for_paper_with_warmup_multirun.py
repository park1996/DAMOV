...
selected_benchmark_suites_and_benchmarks_functions = {"chai" : ["BS_BEZIER_KERNEL"],
    ...
    "splash-2" : ["FFT_Reverse", "FFT_Transpose", "Oceanncp_laplaccalc", "Oceancp_slave2", "Radix_slave_sort"],}
...
selected_avg_xfer_latency_csv_write.close()
selected_avg_qing_latency_csv_write.close()
selected_xfer_percentage_csv_write.close()
selected_qing_percentage_csv_write.close()